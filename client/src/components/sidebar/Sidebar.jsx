...
const categories = [
  ...
  },
  {
    ...
    icon: (<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M2 5h12v8a1 1 0 01-1 1H3a1 1 0 01-1-1V5z" stroke="currentColor" strokeWidth="1.4" /><path d="M2 5l2-3h8l2 3" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" /><path d="M8 8v4M6 10h4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" /></svg>),
    count: 412, color: "text-amber-400", accent: "from-amber-500/10 to-orange-500/10", dot: "bg-amber-400",
  },
  {
    id: "brand", label: "Brand & Logo",
    icon: (<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 2l1.8 3.6L14 6.5l-3 2.9.7 4.1L8 11.5l-3.7 1.9.7-4.1-3-2.9 4.2-.9L8 2z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" /></svg>),
  ...
  },
  {
    ...
    icon: (<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><rect x="2" y="2" width="12" height="12" rx="2" stroke="currentColor" strokeWidth="1.4" /><path d="M2 10.5l3.5-3.5 2.5 2.5 2-2 3.5 4" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" /><circle cx="5.5" cy="5.5" r="1" fill="currentColor" /></svg>),
    count: 698, color: "text-pink-400", accent: "from-pink-500/10 to-rose-500/10", dot: "bg-pink-400",
  },
  {
    id: "portraits", label: "Portraits",
    icon: (<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="5.5" r="2.5" stroke="currentColor" strokeWidth="1.4" /><path d="M3 14c0-2.8 2.2-5 5-5s5 2.2 5 5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" /></svg>),
...
const navItems = [
  ...
  },
  {
    ...
    icon: (<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4 2h8a1 1 0 011 1v10a1 1 0 01-1 1H4a1 1 0 01-1-1V3a1 1 0 011-1z" stroke="currentColor" strokeWidth="1.4" /><path d="M5.5 5.5h5M5.5 8h5M5.5 10.5h3" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" /></svg>),
    badge: "12",
  },
  {
    id: "earnings", label: "Earnings", path: "/earnings",
    icon: (<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6" stroke="currentColor" strokeWidth="1.4" /><path d="M8 5v6M6 6.5C6 5.7 6.9 5 8 5s2 .7 2 1.5S9.1 8 8 8s-2 .7-2 1.5S6.9 11 8 11s2-.7 2-1.5" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" /></svg>),
  },
  {
    id: "saved", label: "Saved", path: "/saved",
    icon: (<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M3 2h10a1 1 0 011 1v11l-5-2.5L4 14V3a1 1 0 011-1z" stroke="currentColor" strokeWidth="1.4" strokeLinejoin="round" /></svg>),
    badge: "5",
  },
  {
...
const Sidebar = ({ collapsed, setCollapsed }) => {
  ...
  return (
    <div>
      <aside
        id="sidebar"
        className={`fixed left-0 top-16 bottom-0 z-40 bg-[#052838] border-r border-white/6 flex flex-col transition-all duration-300 ${collapsed ? "w-16" : "w-60"}`}
      >
        {/* Toggle Button */}
        <button
          onClick={() => setCollapsed(!collapsed)}
          className="absolute -right-3 top-6 w-6 h-6 bg-[#0a0a0f] border border-white/10 rounded-full flex items-center justify-center text-white/40 hover:text-white/80 transition-colors z-10"
        >
            ...
            <div className="flex flex-col gap-0.5">
              {navItems.map((item) => (
                <NavLink
                  ...
                  to={item.path}
                  className={({ isActive }) =>
                    `group flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all duration-200 w-full text-left cursor-pointer ${isActive
            ...
            <div className="flex flex-col gap-0.5">
              {categories.map((cat) => (
                <button
                  ...
                  className={`group flex items-center gap-3 rounded-xl px-3 py-2.5 transition-all duration-200 w-full text-left relative overflow-hidden cursor-pointer border ${activeCategory === cat.id
